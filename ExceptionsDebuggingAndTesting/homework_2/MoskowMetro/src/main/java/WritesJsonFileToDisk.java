...
//private List<Line> lines = new ArrayList<>();
    ...
    //        }
    //        lines.forEach(line1 ->
    //                json1.put(line.getNumber(), getStationsOnLine(line.getStations())));
    //        mapjson1.put("stations", json1);
    //        mapjson1.put("lines", lines);
    //    }
    //}
...
//}
    ...
    //public void getStationToJson1(List<Line> lines) throws Exception {
    //    Map<String, Object> mapjson1 = new LinkedHashMap<>();
    //    Map<String, String[]> json1 = new LinkedHashMap<>();
    //    lines.forEach(line ->
    //            json1.put(line.getNumber(), getStationsOnLine(line.getStations())));
    ...
    //private String[] getStationsOnLine(List<Station> stations) {
    //    String[] array = new String[stations.size()];
    //    for (int i = 0; i < array.length; i++) {
    //        array[i] = stations.get(i).getName();
    //    }
